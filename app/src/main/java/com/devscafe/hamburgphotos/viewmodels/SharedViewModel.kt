...
class SharedViewModel @Inject constructor() : ViewModel() {
    ...
    private var hitsObject = MutableLiveData<HitsItem>()
    val hitsLiveData: LiveData<HitsItem> = hitsObject

    fun shareObject(sharedObject: HitsItem) {
        hitsObject.value = sharedObject
    }
}