...
@HiltViewModel
class MainFragmentViewModel @Inject constructor(private val appRepository: AppRepository) :
    ViewModel(), LifecycleObserver {

    private val mutableLiveData: MutableLiveData<List<HitsItem>> = MutableLiveData()
    val liveData :LiveData<List<HitsItem>> = mutableLiveData

    @Inject
    fun getPhotosList(){
        appRepository.makeCallAPI(mutableLiveData)
    }
